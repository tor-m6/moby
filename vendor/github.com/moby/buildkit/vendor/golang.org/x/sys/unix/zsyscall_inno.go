...
// func ioctl(fd int, cmd uintptr, val int) (err error) {
// 	syscall.Entersyscall()
...
// Automatically generated wrapper for dup2/__go_dup2
//extern __go_dup2
func c___go_dup2(fd1 _C_int, fd2 _C_int) _C_int

func Dup2(from int, to int) (err error) {
	syscall.Entersyscall()
	_r := c___go_dup2(_C_int(from), _C_int(to))
	var errno syscall.Errno
	setErrno := false
	if _r < 0 {
		errno = syscall.GetErrno()
