...
var SkipDir error = errors.New("skip this directory")

// SkipAll is used as a return value from WalkFuncs to indicate that
// all remaining files and directories are to be skipped. It is not returned
// as an error by any function.
var SkipAll error = errors.New("skip all directories")
...
// type WalkDirFunc func(path string, d myos.DirEntry, err error) error
type WalkDirFunc func(path string, d os.FileInfo, err error) error

var lstat = os.Lstat // for testing

// walkDir recursively descends path, calling walkDirFn.
func walkDir(path string, d os.FileInfo, walkDirFn WalkDirFunc) error {
...
func WalkDir(root string, fn WalkDirFunc) error {
	...
	if err != nil {
		...
		err = walkDir(root, info, fn) //&statDirEntry{info}
	}
